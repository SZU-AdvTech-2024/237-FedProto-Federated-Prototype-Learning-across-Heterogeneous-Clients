...
def get_dataset(args, n_list, k_list):
    ...
    if args.dataset == 'mnist':
        ...
        if args.iid:
            ...
            user_groups = mnist_iid(train_dataset, args.num_users)  ##user_groups[i] = a list of idxs of data in datasets 下同
        else:
            ...
            if args.unequal:
                ...
                user_groups, classes_list = mnist_noniid(args, train_dataset, args.num_users, n_list, k_list)  ##classes_list[i] = classes that client i choose
                user_groups_lt = mnist_noniid_lt(args, test_dataset, args.num_users, n_list, k_list, classes_list) ##test data samples
...
def proto_aggregation(local_protos_list):
    ...
    for idx in local_protos_list: ##每个client的protos字典的key，即client标号
